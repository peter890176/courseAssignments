...
public class ImageView extends JFrame implements IView {
  ...
  public ImageView(String caption) {
    ...
    open.setBounds( 95 + insets.left, 5 + insets.top, size.width + 10, size.height);
    this.add(open);
    ...
    unsaved.setBounds( 790 + insets.left, 10 + insets.top, size.width * 2, size.height);
    this.add(unsaved);
    ...
    instructions.setBounds( 240 + insets.left, 45 + insets.top, 700, 30);
    ...
    arg0Label.setBounds( 695 + insets.left, 53 + insets.top, 115, size.height);
    arg0Label.setHorizontalTextPosition(SwingConstants.RIGHT);
    this.add(arg0Label);
    arg0Label.setEnabled(false);

    arg0 = new JTextField("arg0");
    size = arg0.getPreferredSize();
    arg0.setBounds( 770 + insets.left, 50 + insets.top, size.width + 15, size.height);
    this.add(arg0);
    arg0.setEnabled(false);

    arg1Label = new JLabel("arg1:");
    size = arg1Label.getPreferredSize();
    arg1Label.setBounds( 830 + insets.left, 53 + insets.top, size.width, size.height);
    arg1Label.setHorizontalTextPosition(SwingConstants.RIGHT);
    this.add(arg1Label);
    ...
    arg1.setBounds( 870 + insets.left, 50 + insets.top, size.width + 15, size.height);
    this.add(arg1);
    arg1.setEnabled(false);

    arg2Label = new JLabel("arg2:");
    size = arg2Label.getPreferredSize();
    arg2Label.setBounds( 920 + insets.left, 53 + insets.top, size.width, size.height);
    arg2Label.setHorizontalTextPosition(SwingConstants.RIGHT);
    this.add(arg2Label);
    arg2Label.setEnabled(false);

    arg2 = new JTextField("arg2");
    size = arg2.getPreferredSize();
    arg2.setBounds( 960 + insets.left, 50 + insets.top, size.width + 15, size.height);
    this.add(arg2);
  ...
  @Override
  public void addFeatures(ControllerFeatures viewController) {
