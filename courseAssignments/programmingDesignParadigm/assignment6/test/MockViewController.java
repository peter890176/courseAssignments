 ...
 */
public class MockViewController extends MockImageController
        implements MockController, MockControllerFeatures {
  private MockIView view;
  private MockImageModel m;
   ...
   */
  public MockViewController(MockImageModel m) {
    super(m);
    this.m = m;
    MockConverterInterface converter = new MockConverter();
  }

  /**
   * This method set the view class.
   *
   * @param v the view class which is typically transferred from main method.
   */
  public void setView(MockIView v) {
    view = v;
    view.addFeatures(this);
  }

  private void loadImage() {
    imageIcon = formatConverter(prevImage);
    view.displayImage(imageIcon);
    ArrayList<ArrayList<ArrayList<Integer>>> histogram = m.histogramImage("prevImage");
    histogramIcon = formatConverter(histogram);
    ...
    try {
      ...
      switch (function) {
        case "Red-component":
          ...
          imageIcon = formatConverter(currentImage);
          histogramIcon = formatConverter(
        ...
        case "Blur":
          ...
          imageIcon = formatConverter(currentImage);
          histogramIcon = formatConverter(arrayListToHistogram(currentImage));
          imageDisplay();
          m.addImage("currentImage", currentImage);
          functionName = "Blur";
          view.setSplit(true);
        ...
        try {
          switch (functionName) {
            case "Blur":
              ...
              splitImageIcon = formatConverter(splitImage);
  ...
  private ImageIcon formatConverter(ArrayList<ArrayList<ArrayList<Integer>>> arrayListImage) {
