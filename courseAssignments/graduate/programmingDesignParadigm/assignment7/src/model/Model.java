...
import model.operations.DitherOperation;
...
public class Model implements ModelInterface {
  private final Map<String, ImageData> matrixMap = new HashMap<>();
  ...
  public void ditherImage(String imageName, String newImageName) throws Exception {
    ImageData imageData = getImage(imageName);
    DitherOperation ob = new DitherOperation();
  ...
  private ImageData getImage(String imageName) throws Exception {
    ImageData imageData;
    try {
