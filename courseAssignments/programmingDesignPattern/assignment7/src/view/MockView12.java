 ...
 */
public class MockView12 implements InterfaceView {
   ...
   */
  public MockView12(StringBuilder log) {
    this.log = log;
  }
  ...
  @Override
  public String openJFileChooser() {
    log.append("Open JFileChooser ");
    return "sampleImage.jpg";
  }
