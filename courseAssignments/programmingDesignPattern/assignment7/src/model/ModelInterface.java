...
public interface ModelInterface {
  ...
  /**
   * Method to apply dither filter on image. This method takes in the image
   * object and newImageName as the parameters and performs dither operation on
   * the image object and stores the new image in the map with the newImageName
   * as the key.
   *
   * @param imageName    String imageName.
   * @param newImageName image name for dither image.
   */
