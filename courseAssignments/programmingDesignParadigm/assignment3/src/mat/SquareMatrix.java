...
public interface SquareMatrix {
   ...
   * @throws IllegalArgumentException if the given cell does not exist
   *                                  within the bounds of this matrix
   */
  ...
  /**
   * Add this matrix with the other matrix and return the result.
   * Neither this nor the other matrix should be changed
   * as a result of this operation.
   *
   * @param other the other matrix to be added to this
   * @return the sum of this and other matrix
   * @throws IllegalArgumentException if the number of rows and number of columns of
   *                                  the two matrices do not match respectively
   */
   ...
   * @throws IllegalArgumentException if the number of columns of this matrix are not equal to
